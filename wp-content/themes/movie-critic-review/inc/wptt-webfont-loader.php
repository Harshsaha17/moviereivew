...
if ( ! class_exists( 'Movie_Critic_Review_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Movie_Critic_Review_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Movie_Critic_Review_WPTT_WebFont_Loader( $url );
