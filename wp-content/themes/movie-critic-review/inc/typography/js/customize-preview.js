jQuery( document ).ready( function() {
	...
	wp.customize(
		'movie_critic_review_p_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_p_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_p_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_p_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_p_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_p_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_p_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_a_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h1_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h2_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h3_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h4_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h4_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h4_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h4_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_movie_critic_review_h4_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_movie_critic_review_h4_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_movie_critic_review_h4_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_movie_critic_review_h5_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_movie_critic_review_h5_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h5_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h5_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h5_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h5_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h5_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_font_weight',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_font_style',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'movie_critic_review_h6_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
