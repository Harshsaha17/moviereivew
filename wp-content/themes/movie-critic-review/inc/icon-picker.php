...
class Movie_Critic_Review_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'movie-critic-review' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $movie_critic_review_font_awesome_icon_array = movie_critic_review_font_awesome_icon_array();
                    foreach ($movie_critic_review_font_awesome_icon_array as $movie_critic_review_font_awesome_icon) {
                            $icon_class = $this->value() == $movie_critic_review_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($movie_critic_review_font_awesome_icon).'"></i>
                            <span class="movie-critic-review-social-class">'.esc_attr($movie_critic_review_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function movie_critic_review_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'movie-critic-review-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'movie_critic_review_customizer_script' );

if(!function_exists('movie_critic_review_font_awesome_icon_array')){
    function movie_critic_review_font_awesome_icon_array(){
