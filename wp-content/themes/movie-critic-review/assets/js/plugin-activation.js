jQuery(document).ready(function($) {
    'use strict';
    var this_obj = movie_critic_review_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.movie-critic-review-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message movie-critic-review-plugin-install');
                button.addClass('button-primary movie-critic-review-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.movie-critic-review-recommended-plugins .movie-critic-review-activation-note').css('display','block');
    ...
    $(document).on('click', '.movie-critic-review-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .movie-critic-review-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .movie-critic-review-recommended-plugins').css('display','none');
    });
