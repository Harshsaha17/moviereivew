    ...
    <?php if( get_theme_mod( 'vw_sports_toggle_postdate',true) == 1 || get_theme_mod( 'vw_sports_toggle_author',true) == 1 || get_theme_mod( 'vw_sports_toggle_comments',true) == 1 || get_theme_mod( 'vw_sports_toggle_time',true) == 1) { ?>
        <div class="post-info p-2 my-3">
            <?php if(get_theme_mod('vw_sports_toggle_postdate',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('vw_sports_single_postdate_icon','fas fa-calendar-alt')); ?> me-2"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_sports_archive_year, $vw_sports_archive_month, $vw_sports_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
            <?php } ?>

            <?php if(get_theme_mod('vw_sports_toggle_author',true)==1){ ?>
                <span><?php echo esc_html(get_theme_mod('vw_sports_single_post_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('vw_sports_single_author_icon','fas fa-user')); ?> me-2"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span>
            <?php } ?>
            ...
            <?php if(get_theme_mod('vw_sports_toggle_time',true)==1){ ?>
              <span><?php echo esc_html(get_theme_mod('vw_sports_single_post_meta_field_separator', '|'));?></span> <i class="<?php echo esc_attr(get_theme_mod('vw_sports_single_time_icon','fas fa-clock')); ?> me-2"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
            <?php } ?>
        </div>
    <?php } ?>
