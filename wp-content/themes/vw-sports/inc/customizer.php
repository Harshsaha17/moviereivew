...
function vw_sports_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('vw_sports_services',array(
		...
		'description' => __('For more options of game section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/wordpress-sports-theme/">GO PRO</a>','vw-sports'),
		'panel' => 'vw_sports_homepage_panel',
	));
	...
	$wp_customize->add_section('vw_sports_footer',array(
		...
		'panel' => 'vw_sports_homepage_panel',
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/wordpress-sports-theme/">GO PRO</a>','vw-sports'),
	));	
